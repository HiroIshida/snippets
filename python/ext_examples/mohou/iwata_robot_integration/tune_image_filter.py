...
def get_first_rgb() -> RGBImage:
    ...
    for filepath in rosbag_path.iterdir():
        ...
        for topic, msg, _ in bag.read_messages():
            if topic == "/head_camera/rgb/image_raw/compressed":
                rgb_conv = RGBImageConverter(topic)
                bag.close()
...
if __name__ == "__main__":
    ...
    parser.add_argument("-pn", type=str, help="project name", default="iwata")
    parser.add_argument(
